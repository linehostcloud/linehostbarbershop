...
class MapLandlordAuditLogActivityAction
{
    /**
     * @return array{
     *     id:string,
    ...
    public function execute(AuditLog $auditLog): array
    {
        return [
            ...
            'tenant' => [
                'id' => $auditLog->tenant?->getKey(),
                'trade_name' => $auditLog->tenant?->trade_name,
                'slug' => $auditLog->tenant?->slug,
                'label' => $auditLog->tenant?->trade_name
                    ?: $auditLog->tenant?->slug
