...
$landlordDriver = env('LANDLORD_DB_CONNECTION', env('DB_CONNECTION', 'mysql'));
$tenantDriver = env('TENANT_DB_CONNECTION', env('DB_CONNECTION', 'mysql'));

$landlordConnection = $landlordDriver === 'sqlite'
    ? [
        'driver' => 'sqlite',
...
$tenantConnection = $tenantDriver === 'sqlite'
    ? [
        'driver' => 'sqlite',
        'url' => env('TENANT_DB_URL'),
        'database' => env('TENANT_DB_DATABASE', database_path('tenant.sqlite')),
        'prefix' => '',
        'foreign_key_constraints' => env('TENANT_DB_FOREIGN_KEYS', true),
        'busy_timeout' => null,
        'journal_mode' => null,
        'synchronous' => null,
        'transaction_mode' => 'DEFERRED',
...
return [
    ...
    */
    ...
    'default' => env('DB_DEFAULT_CONNECTION', 'landlord'),
